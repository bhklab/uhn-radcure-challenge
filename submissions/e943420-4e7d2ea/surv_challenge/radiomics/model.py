...
class Challenger(pl.LightningModule):
    ...
    def __init__(self, hparams: Namespace):
        ...
        if hparams.design.lower() == '3x':
            self.model = Default_3X()
        elif hparams.design.lower() == 'pad':
            self.model = Default_Pad()
        elif hparams.design.lower() == 'air':
            self.model = Default_Air()
        elif hparams.design.lower() == 'pro':
            self.model = Default_Pro()
        elif hparams.design.lower() == 'gn':
            self.model = Default_GN()
        elif hparams.design.lower() == 'xl':
            self.model = Default_XL()
        elif hparams.design.lower() == 'pro_max':
            self.model = Default_Pro_Max()
        elif hparams.design.lower() == 'extra':
            self.model = Default_Extra()
        elif hparams.design.lower() == 'boost':
            self.model = Default_Boost()
        else:
            self.model = Default()
